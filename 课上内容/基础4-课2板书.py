...
#
#
# 安装 Python 3.6.5 版本（一定要使用群内上传的版本）
# 使用 Pycharm CE（一定要使用群内上传的版本）
#     以上两个软件的安装，使用群文件 『Python 和 Pycharm 安装.zip』 中的方法
...
print('0.5 第一次对比', sin30, sin30 == 0.5)
...
print('0.5 第二次对比', sin30, float_equal(sin30, 0.5))
